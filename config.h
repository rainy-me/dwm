...
static char normbordercolor[] = "#d73a49";
...
static Key keys[] = {
    ...
    // { MODKEY,			XK_e,		spawn,		SHCMD(TERMINAL " -e neomutt ; pkill -RTMIN+12 dwmbl?ocks; rmdir ~/.abook") },
    // { MODKEY|ShiftMask,		XK_e,		spawn,		SHCMD(TERMINAL " -e abook -C ~/.config/abook/ab?ookrc --datafile ~/.config/abook/addressbook") },
